# Assignment 8
This assignment consists of a literature research around AI in the domains (chemistry, biology, ...) of your background. There is no coding to be done.

**Your task:**
- Select 3 papers of contemporary literature (not older than dating from 2023) how ML (or more generally) AI tools are used in state-of-the-art research in your domain. Make sure that all of you have different ones - talk to your collagues and check regularly in the DSA104 repo (I created a folder in the general repo called `literature`.)

- Submit them to the literature folder and add a brief description file for each paper (e.g. a markdown file, a txt, a notebook, ...), which should provide 4 brief sections:

1) a short summary of the content,
2) an outline of the dataset used (size, features, ...),
